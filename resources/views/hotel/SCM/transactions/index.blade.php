    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-800">
                {{ __('Riwayat Transaksi Inventori') }}
            </h2>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="border-b border-gray-100">
                    <form method="GET" action="{{ route('scm.transactions.index') }}" class="p-4 sm:p-6">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="relative rounded-lg shadow-sm">
                                ...
                                <input type="text" name="search" value="{{ request('search') }}"
                                    ...
                                    placeholder="Cari Inventori atau catatan...">
                            </div>
                                ...
                                @foreach($transactions as $trx)
                                    <tr class="hover:bg-gray-50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $trx->type === 'masuk' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                {{ ucfirst($trx->type) }}
                                            </span>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <x-dropdown-action :delete-url="route('scm.transactions.destroy', $trx)" />
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
