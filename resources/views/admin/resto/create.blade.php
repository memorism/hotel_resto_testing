            ...
            <div class="overflow-hidden bg-white rounded-xl shadow-sm border border-gray-200">
                <div class="p-8">
                    ...
                    <div class="flex items-center justify-between pb-5 mb-6 border-b border-gray-200">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Form Tambah Restaurant</h3>
                            <p class="mt-1 text-sm text-gray-500">Lengkapi informasi restaurant pada form di bawah ini.
                            </p>
                        </div>
