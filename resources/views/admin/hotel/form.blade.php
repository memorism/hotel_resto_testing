...
<div class="mb-6">
    ...
    <x-text-input id="name" type="text" name="name" value="{{ old('name', $hotel->name ?? '') }}"
...
<div class="mb-6">
    ...
    <x-text-input id="phone" type="text" name="phone" value="{{ old('phone', $hotel->phone ?? '') }}"
        class="mt-2 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-300 focus:border-indigo-400" />
...
<div class="mb-6">
    ...
    <x-text-input id="email" type="email" name="email" value="{{ old('email', $hotel->email ?? '') }}"
        class="mt-2 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-300 focus:border-indigo-400" />
...
<div class="mb-6">
    ...
    @if(isset($hotel) && $hotel->logo)
        <div class="mt-4">
            <img src="{{ asset('storage/' . $hotel->logo) }}" alt="Logo" class="h-16 rounded-md border">
        </div>
    @endif
</div>
