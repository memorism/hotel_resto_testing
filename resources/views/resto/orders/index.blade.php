<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('resto.orders.create') }}" class="btn btn-primary">Tambah Pesanan</a>
        </div>
    </x-slot>
                    ...
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <select id="perPage" class="form-select form-select-sm"
                                ...
                                <option value="{{ route('resto.orders.index', ['perPage' => 10]) }}" {{ request('perPage') == 10 ? 'selected' : '' }}>10</option>
                                <option value="{{ route('resto.orders.index', ['perPage' => 20]) }}" {{ request('perPage') == 20 ? 'selected' : '' }}>20</option>
                                <option value="{{ route('resto.orders.index', ['perPage' => 50]) }}" {{ request('perPage') == 50 ? 'selected' : '' }}>50</option>
                            </select>
