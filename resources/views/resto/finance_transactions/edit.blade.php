        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('financeresto.finances.update', $finance->id) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="date" name="tanggal" id="tanggal" required
                                    ...
                                    value="{{ old('tanggal', \Carbon\Carbon::parse($finance->tanggal)->format('Y-m-d')) }}">
                            </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <select name="jenis" id="jenis" required
                                    ...
                                    <option value="pemasukan" {{ old('jenis', $finance->jenis) == 'pemasukan' ? 'selected' : '' }}>Pemasukan</option>
                                    <option value="pengeluaran" {{ old('jenis', $finance->jenis) == 'pengeluaran' ? 'selected' : '' }}>Pengeluaran</option>
                                </select>
                            </div>
                            ...
                            <div class="space-y-1 md:col-span-2">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="nominal" id="nominal" required
                                        ...
                                        placeholder="0"
                                        value="{{ old('nominal', $finance->nominal) }}">
                                </div>
                            </div>
                            ...
                            <div class="space-y-1 md:col-span-2">
                                ...
                                <textarea name="keterangan" id="keterangan" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    placeholder="Tambahkan keterangan transaksi">{{ old('keterangan', $finance->keterangan) }}</textarea>
                            </div>
                        </div>
