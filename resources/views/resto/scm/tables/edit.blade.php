    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">ID: #{{ $table->id }}</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="border-b border-gray-100 px-6 py-4">
                    <h3 class="text-lg font-medium text-gray-900">Edit Informasi Meja</h3>
                    <p class="mt-1 text-sm text-gray-500">
                        Perbarui informasi meja restoran
                    </p>
                </div>

                <!-- Form Content -->
                <form method="POST" action="{{ route('scmresto.tables.update', $table->id) }}" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="text" id="table_code" name="table_code" value="{{ $table->table_code }}"
                                    required
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <select name="is_active" id="is_active" required
                                    class="pl-10 py-2 block w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                    <option value="1" {{ $table->is_active ? 'selected' : '' }} class="text-green-600">
                                        Aktif
                                    </option>
                                    <option value="0" {{ !$table->is_active ? 'selected' : '' }} class="text-red-600">
                                        Tidak Aktif
                                    </option>
                                </select>
                            </div>
