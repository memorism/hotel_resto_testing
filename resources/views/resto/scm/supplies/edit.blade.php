    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">ID: #{{ $supply->id }}</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="border-b border-gray-100 px-6 py-4">
                    <h3 class="text-lg font-medium text-gray-900">Edit Informasi Inventori</h3>
                    <p class="mt-1 text-sm text-gray-500">
                        Perbarui informasi Inventori dalam sistem
                    </p>
                </div>

                <!-- Form Content -->
                <form action="{{ route('scmresto.supplies.update', $supply->id) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="text" id="nama_barang" name="nama_barang"
                                    value="{{ $supply->nama_barang }}" required
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="text" id="kategori" name="kategori" value="{{ $supply->kategori }}"
                                    class="pl-10 block w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="number" id="stok" name="stok" value="{{ $supply->stok }}" min="0" required
                                    class="pl-10 block w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                    placeholder="0">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="text" id="satuan" name="satuan" value="{{ $supply->satuan }}"
                                    class="pl-10 block w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
