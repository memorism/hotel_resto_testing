    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <form action="{{ route('resto.shared_customers.update_resto', $customer->id) }}" method="POST"
                    class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            ...
                            <select name="gender" id="gender"
                                ...
                                <option value="L" @if(old('gender', $customer->gender) === 'L') selected @endif>Laki-laki
                                </option>
                                <option value="P" @if(old('gender', $customer->gender) === 'P') selected @endif>Perempuan
                                </option>
                            </select>
