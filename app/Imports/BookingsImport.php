...
class BookingsImport implements ToCollection, WithHeadingRow
{
    ...
    protected $userId; // Tambahkan userId

    public function __construct($uploadOrderId, $userId)
    {
    ...
    public function collection(Collection $rows)
    {
        foreach ($rows as $row) {
            Booking::create([
                ...
                'upload_order_id'                      => $this->uploadOrderId, // Set upload_order_id
                'user_id'                              => $this->userId, // Set user_id
            ]);
        }
    }
}
