...
class SyncDailyIncomeToFinances extends Command
{
    ...
    public function handle()
    {
        ...
        // ===================== HOTEL =====================
        $hotelBookings = HotelBooking::where('approval_status', 'approved')
            ->whereRaw("
        ...
        // ===================== RESTO =====================
        $restoOrders = RestoOrder::where('approval_status', 'approved')
        ...
        $this->info('✅ Pendapatan hotel & resto yang sudah di-approve berhasil disinkronisasi.');
    }
}
