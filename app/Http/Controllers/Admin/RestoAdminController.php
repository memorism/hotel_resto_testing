...
class RestoAdminController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $restos = $query->orderBy('created_at', 'desc')->paginate(10); // Pagination 10 per page
        $cities = Resto::select('city')->distinct()->pluck('city')->filter()->values(); // Untuk filter kota
